...
import com.example.newsapp.databinding.ActivityEventBinding
import com.example.newsapp.room.AppDB
import com.example.newsapp.utils.AddEventAdapter
import com.example.newsapp.utils.CalendarAdapter
...
class PickEventActivity : AppCompatActivity() {
    ...
    companion object {
        const val DB_NAME = "event_texts_db"
    }
